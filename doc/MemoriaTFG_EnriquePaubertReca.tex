...
% Estado del arte
% 	1. Crítica al estado del arte 2. Propuesta
\input{secciones/03_estado_del_arte}

\input{secciones/04_estudio_de_requisitos.tex}

\input{secciones/05_planificacion}
